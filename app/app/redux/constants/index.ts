...
export const TITLE_SUFFIX: string = '| Know Your User'
...
export const MAIN_URL: string = 'https://knowyouruser.ru'
...
export const CONTACT_EMAIL: string = 'chelabov@vk.com'
export const SECURITY_EMAIL: string = 'chelabov@vk.com'
...
export const whitelist: string[] = ['en', 'ru', 'uk', 'pl', 'de']
